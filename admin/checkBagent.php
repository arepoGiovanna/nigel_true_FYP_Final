...
<head>
  ...
  <title>Admin (B. Agent) Panel</title>
...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
      ...
      <li class="active"><a href="checkBagent.php">B. Agent Acc.
			<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
			</a></li>
...
<!-- Unknown use -->
  <!-- <div class="container-fluid" style="margin-top:4em;">
    ...
    <div class="col-md-8">
        <?php
          $query = 'SELECT * FROM bagent_account';
          $stmt = $con->prepare($query);
          $stmt->execute();
          $result = $stmt->get_result();
        ?>
        <h3 class="text-center text-info">Booking Agent Records Present In The Database</h3>
        <table class="table table-striped" id="data-table" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              <td><?= $row['bAgent_ID']; ?></td>
              <td><?= $row['bAgent_name']; ?></td>
              <td style="width:3px"><?= $row['bAgent_email']; ?></td>
              <?php $row['user_type'];?>
              <td><?= $row['bAgent_cNum']; ?></td>
