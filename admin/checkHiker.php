...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
      ...
      <li class="active"><a href="checkHiker.php">Hiker Acc.
			<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
			</a></li>
...
<br /> -->
  ...
  <!-- <div class="container-fluid" style="margin-top:4em;">
    ...
    <div class="col-md-8">
        <?php
          $query = 'SELECT * FROM hiker_account';
          $stmt = $con->prepare($query);
          $stmt->execute();
          $result = $stmt->get_result();
        ?>
        <h3 class="text-center text-info">Hiker Records Present In The Database</h3>
        <table class="table table-striped" id="data-table" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              <td><?= $row['hikerID']; ?></td>
              <td><?= $row['hikerUname']; ?></td>
              <td style="width:3px"><?= $row['hikerEmail']; ?></td>
              <td><?= $row['hiker_pNum']; ?></td>
              
              <td>
                <a href="deleteAdmin/editDeleteHiker.php?delete=<?= $row['hikerID']; ?>" class="badge bg-danger p-2" onclick="return confirm('Do you want delete this record?');">Delete</a> |
                <a href="editUser.php?edit=<?= $row['hikerID']; ?>" class="badge bg-success p-2">Edit</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
