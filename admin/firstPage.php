				...
				<div class="container-fluid">
					...
					<div class="form-group">
						...
						<select id="route-id" class="btn btn-default" name="" onchange="javascript:location.href = this.value;">
							...
							<option value="firstPage.php" selected>Via Ferrata Route</option>
							<option value="ranauRoute.php">Ranau Route</option>
...
<div class="via-ferrata section">
	<div class="container-fluid" >
		...
		<div class="col-md-4" id="bookingPanel">
			<div class="panel panel-default">
				<div class="panel-body" >
					<center><img src="../images/via_ferrata.png" alt="Map of Via Ferrata" width="500" height="300"></center>
				<hr> 
							...
							<div class="d-flex justify-content-center">
								...
								<tbody>
									...
									<tr name="slot">
										...
										<!--MODAL  -->
											<!-- Trigger open modal -->
											<button id="myBtn" class="btn" onclick="turnVisible('#myModal')" >Book</button> 
										</td>
									</tr>
									<?php } ?>
								</tbody>
	...
	<div class="modal-content">
		...
		<div class="modal-footer">
			<div class="form-group"> 
				...
				<!-- <input type="submit" class="btn btn-info" value="Submit" name="submit" action="../admin/selectMguide.php">SUBMIT</input> -->
				</div>
			</div>
		</div>
	</div>
